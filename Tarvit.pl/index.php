			...
			<div class="card-body">
				<form name="OfferSearch" id="OfferSearch" method="POST" action="php/offersearch.php">
					<div class="form-outline mb-4">
						...
						<select class="form-select" id="HouseTypeInput" name="HouseTypeInput">
					...
					<!-- GEO API dodać-->
					<input type="text" class="form-control" id="HouseLocation" name="HouseLocation" placeholder="Miejscowość" aria-label="HouseLocationInput" style="float:left;">
